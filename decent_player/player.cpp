...
Move *openingBook(string move_history)
{
	...
	if ('a' > opening_move[0]) {
		Move * m = new Move((int) (opening_move[0] - 'A'), opening_move[1] + 1)
	}
	else {
		Move * m = new Move((int) (opening_move[0] - 'a'), opening_move[1] + 1)
	}
